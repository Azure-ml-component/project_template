...
def microsoft_com_azureml_samples_compare_2_models(
    ...
    if _microsoft_com_azureml_samples_compare_2_models is None:
        _microsoft_com_azureml_samples_compare_2_models = Component.from_yaml(yaml_file=SOURCE_DIRECTORY / "get-started/microsoft_com_azureml_samples_compare_2_models/0.0.2/compare2.yaml")
...
def samples_evaluate(
    ...
    if _samples_evaluate is None:
        _samples_evaluate = Component.from_yaml(yaml_file=SOURCE_DIRECTORY / "get-started/samples_evaluate/0.0.5/eval.yaml")
...
def samples_mpi_train(
    ...
    if _samples_mpi_train is None:
        _samples_mpi_train = Component.from_yaml(yaml_file=SOURCE_DIRECTORY / "get-started/samples_mpi_train/0.0.7/mpi_train.distributed.component.yaml")
...
def samples_score(
    ...
    if _samples_score is None:
        _samples_score = Component.from_yaml(yaml_file=SOURCE_DIRECTORY / "get-started/samples_score/0.0.4/score.yaml")
...
def samples_train(
    ...
    if _samples_train is None:
        _samples_train = Component.from_yaml(yaml_file=SOURCE_DIRECTORY / "get-started/samples_train/0.0.5/train.yaml")
